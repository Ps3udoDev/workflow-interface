  ...
  return (
    ...
    >
      <Dialog.Portal>
        ...
        <Dialog.Content
          className='fixed drop-shadow-md top-[50%] left-[50%] max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-auto md:max-w-[700px] translate-x-[-50%] translate-y-[-50%] rounded-md bg-[#23262c] p-[25px] focus:outline-none'
        >
